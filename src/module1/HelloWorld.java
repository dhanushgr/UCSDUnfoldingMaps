...
public class HelloWorld extends PApplet {
	...
	public void setup() {
		size(800, 600, P3D); // Set up the Applet window to be 800x600
		...
		// MapTileProvider source = new OSMMapTileProvider();
		// Set a zoom level
		int zoomLevel = 10;
...
//		map2 = new UnfoldingMap(this, 50, 50, 350, 500, provider);
		...
		map2.zoomAndPanTo(zoomLevel, new Location(12.274413f, 76.622923f));
